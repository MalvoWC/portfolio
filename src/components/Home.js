...
export default function Home() {
    ...
    return (
        <div name='home' className='w-full h-full py-[10rem] bg-[#051c3e]'>
            <div className='max-w-[1000px] flex flex-col justify-center pt-[10rem] items-center'>
                <div className='ml-[5rem] md:ml-[10rem]'>
